...
pub use chute_remote_pairs::find_chute_remote_pairs;
pub use death_blossom::find_death_blossoms;
pub use digit_forcing_chains::find_digit_forcing_chains;
pub use extended_unique_rectangles::find_extended_unique_rectangles;
pub use finned_swordfish::find_finned_swordfish;
pub use finned_x_wing::find_finned_x_wings;
pub use fireworks::find_fireworks;
pub use fish::find_jellyfish;
pub use fish::find_swordfish;
pub use fish::find_x_wings;
pub use grouped_x_cycles::find_grouped_x_cycles;
...
pub use sue_de_coq::find_sue_de_coq;
...
mod death_blossom;
mod digit_forcing_chains;
mod extended_unique_rectangles;
mod finned_swordfish;
mod finned_x_wing;
mod fireworks;
mod fish;
mod grouped_x_cycles;
mod hidden_singles;
mod hidden_tuples;
