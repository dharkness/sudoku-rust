...
pub const TECHNIQUES: [Technique; 25] = [
    ...
    Technique::new(Difficulty::Tough, "two-string kite", algorithms::find_two_string_kites),
    ...
    Technique::new(Difficulty::Diabolical, "fireworks", algorithms::find_fireworks),
