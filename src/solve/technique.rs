...
#[rustfmt::skip]
pub const TECHNIQUES: [Technique; 26] = [
...
#[rustfmt::skip]
pub const NON_PEER_TECHNIQUES: [Technique; 25] = [
...
#[rustfmt::skip]
pub const MANUAL_TECHNIQUES: [Technique; 23] = [
    ...
    TECHNIQUES[23], TECHNIQUES[24], TECHNIQUES[25],
];
